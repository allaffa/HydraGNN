...
srun -n1 python -u ./examples/ensemble_learning/inference_alloy_postprocess.py --models_dir_folder=examples/ensemble_learning/alloy_ternary_energy_Nov11 --log="EL_ternary_energy3_Nov11" --nprocs=16
srun -n1 python -u ./examples/ensemble_learning/inference_alloy_postprocess_cross.py --models_dir_folder=examples/ensemble_learning/alloy_ternary_energy_Nov11 --log="EL_cross_ternary2binary_energy3_Nov11" --nprocs=16
srun -n1 python -u ./examples/ensemble_learning/inference_alloy_postprocess_cross.py --models_dir_folder=examples/ensemble_learning/alloy_binary_energy_Nov11 --log="EL_cross_binary2ternary_energy3_Nov11" --nprocs=16

srun -n1 python -u ./examples/ensemble_learning/inference_alloy_postprocess_cross.py --models_dir_folder=examples/ensemble_learning/alloy_ternary_rmsd  --log="EL_cross_ternary2binary_rmsd3" --nprocs=16
#srun -n1 python -u ./examples/ensemble_learning/inference_alloy_postprocess_cross.py --models_dir_folder=examples/ensemble_learning/alloy_ternary_energy --log="EL_cross_ternary2binary_energy3" --nprocs=16

srun -n1 python -u ./examples/ensemble_learning/inference_alloy_postprocess_cross.py --models_dir_folder=examples/ensemble_learning/alloy_binary_rmsd_1,examples/ensemble_learning/alloy_binary_rmsd_2 --log="EL_cross_binary2ternary_rmsd3" --nprocs=16
#srun -n1 python -u ./examples/ensemble_learning/inference_alloy_postprocess_cross.py --models_dir_folder=examples/ensemble_learning/alloy_binary_energy --log="EL_cross_binary2ternary_energy3" --nprocs=16
