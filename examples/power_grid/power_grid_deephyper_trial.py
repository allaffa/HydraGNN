...
def main():
    ...
    parser.add_argument("--model_type", help="model_type", default="PNA")
    ...
    parser.add_argument("--log", help="log name", default="PowerGrid")
    ...
    parser.add_argument(
        "--compute_power_flow",
        action="store_true",
        help="use residual of power flow equation as physics-informed term in the training loss function",
        default=False,
    )
    ...
    hydragnn.train.train_validate_test(
        ...
        verbosity,
        create_plots=False,
        compute_power_flow=args.compute_power_flow,
    )
