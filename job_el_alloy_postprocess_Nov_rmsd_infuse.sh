...
srun -N1 -n8 -c7 --gpus-per-task=1 --gpu-bind=closest python -u ./examples/ensemble_learning/inference_alloy.py --models_dir_folder=examples/ensemble_learning/alloy_binary_infuse_rmsd  --dataname=alloy_ternary_rmsd --log="EL_cross_binaryinfuse2ternary_rmsd3_Dec9_final"
